...
Others: None
**********************************************************/
BM22S3421_1::BM22S3421_1(uint8_t statusPin, HardwareSerial *theSerial)
{
  _softSerial = NULL;
...
Others: None
**********************************************************/
BM22S3421_1::BM22S3421_1(uint8_t statusPin, uint8_t rxPin, uint8_t txPin)
{
  _hardSerial = NULL;
  _statusPin = statusPin;
  _rxPin = rxPin;
...
Others: None
**********************************************************/
uint8_t BM22S3421_1::getSTATUS()
{
  return digitalRead(_statusPin);
}

/**********************************************************
Description: Query alcohol concentration AD value
Parameters: None
Return: alcohol concentration AD value(12-bit)
Others: None
**********************************************************/
uint16_t BM22S3421_1::readADValue()
{
  uint16_t ADValue = 0;
  uint8_t ADValueH = 0, ADValueL = 0;
...
/**********************************************************
Description: Read the current alcohol concentration level
Parameters: None
Return: 1:Level1; 2:Level2; 3:Level3; 4:Level4
Others: None
**********************************************************/
uint8_t BM22S3421_1::readAlcLevel()
{
...
**********************************************************/
uint8_t BM22S3421_1::readParam(uint8_t cmd, uint8_t addr)
{
  uint8_t retFlag;
...
**********************************************************/
bool BM22S3421_1::isInfoAvailable()
{
  uint8_t header[5] = {0xAA, 0x0E, 0x42, 0x01, 0xAC}, headerLen = 5; // Fixed code for first 5 bytes of 14-byte data
...
**********************************************************/
void BM22S3421_1::readInfoPackage(uint8_t array[])
{
...
Others: 1. Consult the command table of the BM22S3021-1 datasheet
        2. Not applicable to "Common Command"
**********************************************************/
uint8_t BM22S3421_1::writeCommand(uint8_t cmd, uint8_t addr, uint8_t param)
{
...
Others: None
**********************************************************/
uint8_t BM22S3421_1::requestInfoPackage(uint8_t array[])
{
  uint8_t i, retFlag;
...
**********************************************************/
uint8_t BM22S3421_1::restoreDefault()
{
...
**********************************************************/
uint8_t BM22S3421_1::calibrateModule(uint8_t calibrateParam)
{
...
Others: None
**********************************************************/
void BM22S3421_1::clear_UART_FIFO()
{
  if (_softSerial != NULL)
  {
...
Others: None
**********************************************************/
void BM22S3421_1::writeBytes(uint8_t wbuf[], uint8_t wLen)
{
  clear_UART_FIFO();
  /*Select hardSerial or softSerial according to the setting*/
  if (_softSerial != NULL)
...
Others: None
**********************************************************/
uint8_t BM22S3421_1::readBytes(uint8_t rBuf[], uint8_t rLen, uint16_t timeout)
{
  uint16_t delayCnt = 0;
