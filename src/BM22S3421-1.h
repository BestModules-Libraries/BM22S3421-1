...
******************************************************************/
#ifndef _BM22S3421_1_H_
#define _BM22S3421_1_H_
...
{
public:
  BM22S3421_1(uint8_t statusPin, HardwareSerial *theSerial = &Serial);
  BM22S3421_1(uint8_t statusPin, uint8_t rxPin, uint8_t txPin);
  void begin();
  uint8_t getSTATUS();
  uint16_t readADValue();
  uint8_t readAlcLevel();
